...
float Gyro_angle[2];
float Total_angle[2];
long angle_x_error, angle_y_error, angle_z_error;
...
//    Serial.println("Dropping Ball");
  ...
  if((rc_values[RC_CH3] <= 1000) && (rc_values[RC_CH4] <= 1000) && !isArmed){
    isArmed = true;
...
//    Serial.print("CH4:"); Serial.println(rc_values[RC_CH4]);
    ...
    throttle1 = throttle1 - pid_roll;
    throttle4 = throttle4 - pid_roll;
    throttle2 = throttle2 + pid_roll;
    throttle3 = throttle3 + pid_roll;
    

    throttle1 = throttle1 + pid_pitch;
    throttle2 = throttle2 + pid_pitch;
    throttle3 = throttle3 - pid_pitch;
    throttle4 = throttle4 - pid_pitch;
